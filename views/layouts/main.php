                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php else: ?>
                            ...
                            <?php endif; ?>
                            <li><a href="<?=Url::to(['/user/default/message'])?>"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span>消息<span class="badge background_message"><?=count($user->findMessagesUnReadCount($user->uid))?></span></a></li>
