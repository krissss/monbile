...
/**
 * 关联用户信息
 * user/default/relations-front  user/default/relations-back    fragment/hot_user.php
 * 在包含页面需定义以下变量
 */
...
<div class="media panel">
    <div class="panel-body">
        ...
        <div class="media-body">
            ...
            <div class="col-xs-6"><a href="<?= Url::to(['/user/default/videos','id'=>$user_relation->uid]) ?>">视频<span class="badge"><?=count($user_relation->videos)?></span></a></div>
            <?php if($is_hot_user):?>
