...
<div class="user-info">
    <div class="text-center">
        ...
        <h3><?= $user->nickname ?><?php if($other_user):?><small><span class="label label-primary"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>关注</span></small><?php endif; ?></h3>
    </div>
    <div class="panel panel-default">
        <div class="panel-body text-center">
            ...
            <div class="col-xs-5"><a href="<?= Url::to(['/user/default/index','id'=>$user->uid]) ?>"><?=$other_user?'他的主页':'我的主页'?></a></div>
            <div class="col-xs-1">|</div>
            <div class="col-xs-5"><a href="<?= Url::to(['/user/default/videos','id'=>$user->uid]) ?>"><?=$other_user?'他的视频':'我的视频'?></a></div>
        </div>
    </div>
</div>